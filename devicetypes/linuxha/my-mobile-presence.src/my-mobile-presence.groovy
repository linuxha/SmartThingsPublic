...
metadata {
	definition (name: "My Mobile Presence", namespace: "linuxha", author: "SmartThings") {
...
def parse(String description) {
    ...
    log.debug "mobilePresence - $description"
	...
	log.debug "Parse returned $results.descriptionText ($results.value)"
	return results
